 ...
 var BundleID = "com.Dairyfresh"
 var appStoreID =  1487603837
 var mailId = "jaltesh.itmolen@gmail.com"
 var appFullName = "Dairyfresh"
 ...
 func setGradientColor(button: UIView,style: UIGradientStyle,colors: [UIColor]) -> UIColor {
    return (UIColor(gradientStyle:style, withFrame:CGRect(x: button.frame.origin.x, y: button.frame.origin.y, width: button.bounds.size.width, height: button.bounds.size.height), andColors:colors))
 }
